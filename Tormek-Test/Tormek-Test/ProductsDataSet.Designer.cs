...
namespace Tormek_Test {
    ...
    public partial class ProductsDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(string Name, double Width, double Height, double Depth, double Weight, string Description) {
        ...
        public partial class ProductRow : global::System.Data.DataRow {
            ...
            public double Depth {
                get {
                    return ((double)(this[this.tableProduct.DepthColumn]));
                }
                set {
...
namespace Tormek_Test.ProductsDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Product] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_" +
                "Name) AND ([Width] = @Original_Width) AND ([Height] = @Original_Height) AND ([De" +
                "pth] = @Original_Depth) AND ([Weight] = @Original_Weight))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Product] ([Name], [Width], [Height], [Depth], [Weight], [Description]) VALUES (@Name, @Width, @Height, @Depth, @Weight, @Description);
SELECT Id, Name, Width, Height, Depth, Weight, Description FROM Product WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [Name] = @Name, [Width] = @Width, [Height] = @Height, [Depth] = @Depth, [Weight] = @Weight, [Description] = @Description WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Width] = @Original_Width) AND ([Height] = @Original_Height) AND ([Depth] = @Original_Depth) AND ([Weight] = @Original_Weight));
SELECT Id, Name, Width, Height, Depth, Weight, Description FROM Product WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Tormek_Test.Properties.Settings.Default.ProductsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Width, Height, Depth, Weight, Description FROM dbo.Product";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, double Original_Width, double Original_Height, double Original_Depth, double Original_Weight) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((double)(Original_Depth));
        ...
        public virtual int Insert(string Name, double Width, double Height, double Depth, double Weight, string Description) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((double)(Depth));
        ...
        public virtual int Update(string Name, double Width, double Height, double Depth, double Weight, string Description, int Original_Id, string Original_Name, double Original_Width, double Original_Height, double Original_Depth, double Original_Weight, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((double)(Depth));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((double)(Original_Depth));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, double Width, double Height, double Depth, double Weight, string Description, int Original_Id, string Original_Name, double Original_Width, double Original_Height, double Original_Depth, double Original_Weight) {
            return this.Update(Name, Width, Height, Depth, Weight, Description, Original_Id, Original_Name, Original_Width, Original_Height, Original_Depth, Original_Weight, Original_Id);
        }
    }
